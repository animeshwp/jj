                ...
                <div class="col-xl-12 col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <!--end::Header-->
                            <!--begin::Form-->
                            <form method="post" action="<?php echo base_url('admin/notice/save');?>"
                                enctype='multipart/form-data'>
                                <!--begin::Body-->
                                <div class="col-md-12">
                                    <div class="card-body">
                                        <div class=""> <input type="text" name="data[notice_title]" class="form-control"
                                                id="title" value="<?php echo set_value('data[post_title]'); ?>"
                                                required />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="card-header">
                                        ...
                                        <div class="mb-3"> <input type="date" name="data[notice_date]"
                                                ...
                                                value="<?php echo set_value('data[notice_date]'); ?>" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="card-header">
                                        ...
                                        <div class="form-check"> <input class="form-check-input" type="radio"
                                                name="data[status]" id="gridRadios1" value="1"> <label
                                                class="form-check-label" for="gridRadios1"> Published </label>
                                        </div>
                                        <div class="form-check"> <input class="form-check-input" type="radio"
                                                name="data[status]" id="gridRadios1" value="0"> <label
                                                class="form-check-label" for="gridRadios1"> Draft </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="card-footer"> <input type="submit"
                                            class="btn btn-primary btn-lg btn-block" name="Save" value="Save">
                                    </div>
                                </div>
                        </div>
                        <!--end::Input Group-->
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody> <?php foreach ( $notices as $notice ): ?> <tr class="align-middle">
                                        ...
                                        <td width="12%">
                                            <?php  echo en2bnNumber(mdate("%d-%m-%Y %H:%i:%s", strtotime($notice->notice_date)));?>
                                        </td>
                                        <td><span
